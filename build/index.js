...
export default class JScroll {
  ...
  tick() {
    ...
    if ( this.isScrollTo && (state.currentRounded !== state.target) ) {
        this.scrollToHandler( state );
    }
    if ( this.isScrollTo && (state.currentRounded === state.target) ) {
        this.isScrollTo = false;
        this.scrollToHandler( state );
        this.scrollToResolve();
    }
  }
  ...
  scrollTo(offset, handler = () => {}) {
    this.isScrollTo = true;
    this.state.target = offset;
    return new Promise(( resolve ) => {
        this.scrollToResolve = resolve;
        this.scrollToHandler = handler;
    });
  }
}
